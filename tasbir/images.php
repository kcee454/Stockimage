...
<div class="container pp-section">
  <div class="row">
    <div class="col-md-9 col-sm-12 px-0">
      <h1 class="h3">Beautiful Photos Captured by Worldclass Photographers</h1>
    </div>
  </div>
</div>
...
?>
      ...
      <div class="card" data-groups="[&quot;nature&quot;]"><a href="image-detail.php?filename=<?php echo $row["file_name"] ?> ">
